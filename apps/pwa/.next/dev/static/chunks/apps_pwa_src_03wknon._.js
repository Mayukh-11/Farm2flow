                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        ...
                                        children: "← Back to Login / Sign Out"
                                    }, void 0, false, {
                                        fileName: "[project]/apps/pwa/src/app/farmer/page.tsx",
                                        lineNumber: 298,
                                        columnNumber: 17
...
var _s = __turbopack_context__.k.signature();
;
const ListProduceWizard = ({ isOpen, onClose, onSuccess, initialCrop = 'Tomato' })=>{
    _s();
    ...
    const toggleWizardSpeech = ()=>{
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            rec.onstart = ()=>{
                ...
                setVoiceNotice('Listening... say crop, quantity, or price (e.g. "500 kg at 32 rupees")');
            };
            rec.onresult = (event)=>{
                const text = event.results[0][0].transcript.toLowerCase();
                setVoiceNotice(`Heard: "${text}"`);
                // Check for crop
                if (text.includes('tomato')) setSelectedCrop('Tomato');
                if (text.includes('potato') || text.includes('alu')) setSelectedCrop('Potato');
                if (text.includes('onion') || text.includes('pyaj')) setSelectedCrop('Onion');
                if (text.includes('rice') || text.includes('chawal')) setSelectedCrop('Rice');
                ...
                // Check for grade
                if (text.includes('grade a')) setGrade('Grade A');
                if (text.includes('grade b')) setGrade('Grade B');
            };
            rec.onerror = ()=>{
                setIsWizardListening(false);
            };
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: cropOptions.map((crop)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            className: `p-3.5 rounded-2xl border text-left flex flex-col gap-1 transition-all ${selectedCrop === crop.name ? 'border-2 border-primary bg-primary-container/10 ring-1 ring-primary' : 'border-outline-variant bg-surface-container-lowest hover:bg-surface-container-low'}`,
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-2xl",
                                                    children: crop.icon
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    onClick: ()=>setStep(2),
                                    className: "mt-3 w-full py-3.5 bg-primary-container text-on-primary rounded-xl text-[14px] font-bold hover:bg-primary transition-colors flex items-center justify-center gap-2",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(ListProduceWizard, "TmAeNn9thwX7dURMk2E0x3AfpdM=");
...
var _s = __turbopack_context__.k.signature();
;
const PredefinedHelpModal = ({ isOpen, onClose, onSelectAction, language = 'EN' })=>{
    _s();
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                if (SpeechRecognition) {
                    ...
                    recognition.onstart = ({
                        "PredefinedHelpModal.useEffect": ()=>{
                            setIsListening(true);
                            setFeedback('Listening... Please speak (e.g. "Sell tomato", "Show prices", "Track orders")');
                        }
                    })["PredefinedHelpModal.useEffect"];
                    recognition.onresult = ({
                        "PredefinedHelpModal.useEffect": (event)=>{
                    ...
                    recognition.onerror = ({
                        "PredefinedHelpModal.useEffect": (event)=>{
                            ...
                            setFeedback(`Voice error: ${event.error}. Please try again or tap an action below.`);
                        }
                    })["PredefinedHelpModal.useEffect"];
                    recognition.onend = ({
                        "PredefinedHelpModal.useEffect": ()=>{
    ...
    // When transcript updates and speech finishes, analyze intent
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PredefinedHelpModal.useEffect": ()=>{
    ...
    const toggleListening = ()=>{
        if (isListening) {
            ...
            setTranscript('');
            setFeedback('Initializing microphone...');
            try {
                if (!recognitionRef.current) {
                    const SpeechRecognition = window.SpeechRecognition || window.webkitSpeechRecognition;
                    if (!SpeechRecognition) {
                        setFeedback('Web Speech API is not supported in this browser. Please use Chrome/Edge or tap an option below.');
                        return;
                    }
                }
                ...
                console.error(err);
                setFeedback('Could not start microphone. Please check permissions.');
            }
        }
    };
    const handleVoiceCommand = (text)=>{
        const lower = text.toLowerCase();
        setFeedback(`Interpreted: "${text}"`);
        // Match keywords for Sell / List produce
        if (lower.includes('sell') || lower.includes('list') || lower.includes('bikri') || lower.includes('bechna') || lower.includes('produce') || lower.includes('crop')) {
            let detectedCrop = 'Tomato';
            if (lower.includes('potato') || lower.includes('alu') || lower.includes('aaloo')) detectedCrop = 'Potato';
            if (lower.includes('onion') || lower.includes('pyaj') || lower.includes('peyaj')) detectedCrop = 'Onion';
            if (lower.includes('rice') || lower.includes('chawal') || lower.includes('dhan')) detectedCrop = 'Rice';
            setFeedback(`Recognized command: "Sell Produce (${detectedCrop})". Launching wizard...`);
            setTimeout(()=>{
                onSelectAction('sell', {
                    crop: detectedCrop
                });
        ...
        // Match keywords for Prices / Mandi rate
        if (lower.includes('price') || lower.includes('rate') || lower.includes('dam') || lower.includes('daam') || lower.includes('bhaav') || lower.includes('mandi')) {
            setFeedback('Recognized command: "Check Market Rates". Navigating...');
            setTimeout(()=>{
        ...
        // Match keywords for Orders / Tracking
        if (lower.includes('order') || lower.includes('track') || lower.includes('dispatch') || lower.includes('status') || lower.includes('delivery')) {
            setFeedback('Recognized command: "Track Orders". Navigating...');
            setTimeout(()=>{
        ...
        // Match keywords for Market intelligence
        if (lower.includes('market') || lower.includes('demand') || lower.includes('forecast')) {
            setFeedback('Recognized command: "Market Intelligence". Navigating...');
            setTimeout(()=>{
        ...
        setFeedback(`Heard: "${text}". Please tap an option below or speak clearly.`);
    };
    if (!isOpen) return null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                            className: "text-[17px] font-extrabold text-on-surface",
                                            children: "Voice Command Assistant"
                                        }, void 0, false, {
                                            fileName: "[project]/apps/pwa/src/components/PredefinedHelpModal.tsx",
                                            lineNumber: 169,
                                            columnNumber: 15
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-[12px] text-on-surface-variant font-medium",
                                            children: "Speak in English, Bengali, or Hindi"
                                        }, void 0, false, {
                                            fileName: "[project]/apps/pwa/src/components/PredefinedHelpModal.tsx",
                                            lineNumber: 170,
                                            columnNumber: 15
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-surface-container-low border border-outline-variant rounded-2xl p-4 flex flex-col items-center text-center gap-3",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                transcript ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-[14px] font-extrabold text-primary bg-white py-2 px-3 rounded-xl border border-outline-variant",
                                    children: [
                                        '"',
                                        transcript,
                                        '"'
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$pwa$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-[12px] font-bold text-on-surface-variant",
                                    children: feedback || 'Tap the mic and speak: "Sell tomato", "Show prices", or "Track orders"'
                                }, void 0, false, {
                                    fileName: "[project]/apps/pwa/src/components/PredefinedHelpModal.tsx",
                                    lineNumber: 203,
                                    columnNumber: 13
...
_s(PredefinedHelpModal, "iD8YZqjcpPnbRA+EqT7T/OTMWBQ=");
...
//# sourceMappingURL=apps_pwa_src_03wknon._.js.map