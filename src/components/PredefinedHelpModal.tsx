      ...
      <div className="w-full max-w-[430px] bg-surface rounded-t-2xl sm:rounded-2xl p-5 border border-outline-variant shadow-xl flex flex-col gap-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between border-b border-outline-variant pb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-headline-sm font-bold text-on-surface">Farm2Flow Voice & Help Assistant</h3>
              <p className="text-body-sm text-on-surface-variant text-[12px]">Ask questions or trigger instant voice commands</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="bg-surface-container-low p-3.5 rounded-xl border border-outline-variant flex items-center gap-3">
          <span className="material-symbols-outlined text-secondary text-[24px] animate-pulse">record_voice_over</span>
          <div>
            <p className="text-label-md font-bold text-on-surface">Listening for agricultural queries...</p>
            <p className="text-body-sm text-[12px] text-on-surface-variant">Tap any quick prompt below to simulate instant response:</p>
          </div>
        </div>
